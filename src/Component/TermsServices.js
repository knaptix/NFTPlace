        ...
        <div className="container mx-auto px-6 py-12">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="text-gray-600">Last Updated: 12/25/2024</p>
                </div>

                {/* Introduction */}
                <section className="mb-10">
                    <p className="text-gray-700 mb-4">
                        This website is operated by NEW YORK WORLD NFT (NYWNFT). Throughout the site, the terms "we", "us" and "our"
                        refer to NYWNFT. NYWNFT offers this website, including all information, tools, and services available from
                    ...
                    <p className="text-gray-700 mb-4">
                        Any new features or tools added to the current store shall also be subject to the Terms of Service. You can
                        ...
                        access to the website after posting any changes constitutes acceptance of those changes.
                    </p>
                </section>

                {/* Online Marketplace Terms */}
                <section className="mb-10">
                    <h2 className="text-2xl font-semibold mb-4">Online Marketplace Terms</h2>
                    <p className="text-gray-700 mb-4">
                        By agreeing to these Terms of Service, you represent that you are at least the age of majority in your state
                        or province of residence, and you have given us your consent to allow any of your minor dependents to use
                        this site. You may not use our products for any illegal or unauthorized purpose nor may you, in the use of
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        of the Terms will result in an immediate termination of your Services. We reserve the right to refuse
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        affect these Terms. New York World NFT does not guarantee a minimum or maximum number of items, nor does
                        NYWNFT guarantee that items that are available right now will remain available in the future.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        This site information is for your reference only. We reserve the right to modify the contents of this site
                    ...
                    <p className="text-gray-700 mb-4">
                        We are not responsible for the wrong categorization of items, missing or damaged downloads, or install
                        files. We cannot be held responsible under any circumstance for damage that may or may not have been caused
                        by downloading, installing, or using our site or any of the items offered on our site.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        to you or any third party for any modification, price change, suspension, or discontinuance of the Service,
                        products or services.
                    </p>
                    <p className="text-gray-700 mb-4">
                        Certain products or services may be available exclusively online through the website. These products or
                        services may have limited quantities. We have made every effort to display accurately, possibly the colors
                        and images of our products that appear at the store. We cannot guarantee that your computer monitor's
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        to limit the quantities of any products or services we offer. All descriptions of products or product
                        pricing are subject to change at any time without notice, at the sole discretion of us.
                    </p>
                    <p className="text-gray-700 mb-4">
                        We reserve the right to discontinue any product at any time. Any offer for any product or service made on
                        this site is void where prohibited. We do not warrant that the quality of any products, services,
                        information, or other material purchased or obtained by you will meet your expectations, or that any errors
                        in the Service will be corrected.
                    </p>
                    <p className="text-gray-700 mb-4">
                        All items offered on the site are copyrighted by their respective owners. This may be New York World NFT or
                        this may be 3rd party designers/creators/developers. We are allowed to issue the work of designers under our
                        license.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        We may provide you, with access to third-party tools, which we neither monitor nor have any control or
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        for any comments; or (3) to respond to any comments. We may, but have no obligation to, monitor, edit, or
                        remove content that we determine in our sole discretion are unlawful, offensive, threatening, libelous,
                        defamatory, pornographic, obscene, or otherwise objectionable or violates any party's intellectual property
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        or third parties as to the origin of any comments. You are solely responsible for any comments you make and
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        prohibited uses. You may never resell or redistribute the digital source files unless explicitly stated, you
                        received written permission from New York World NFT, the designer, or purchased a separate license allowing
                        you to do so.
                    </p>
                    <p className="text-gray-700 mb-4">
                        When deliberately breaching this clause, you agree that this will result in a $500 fine per breach, with a
                        minimum fine of $10000. You agree to respect the license agreement associated with your account. This
                        license will remain active forever, even after the cancellation of your subscription /account or our
                        cancellation of the service. After you stop your subscription, you, are not allowed to use the downloaded
                        items to create new work. Breaching of this clause will result in a $200 compensation per breach.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        periods or cancel the service at any time, without notice to you. You expressly agree that your use of, or
                    ...
                    <p className="text-gray-700 mb-4">
                        In no case shall New York World NFT, our directors, officers, employees, affiliates, agents, contractors,
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        You agree to indemnify, defend and hold harmless New York World NFT and our parent, subsidiaries,
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        All files offered are owned by their respective creators. On the product page, it's listed who this is. When
                        you purchase a digital download you purchase 1 single license for up to 3 of your devices unless your
                        license states otherwise. This license, called the New York World NFT, grants you the right to use the files
                        for as long as you are an active paying subscriber, but you never buy the full rights and ownership over
                        these files. We are allowed, to retroactively update the terms and conditions of our New York World NFT
                        License and apply this to past and future purchases.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        Services, or when you cease using our site. If in our sole judgment, you fail, or we suspect that you have
                        failed, to comply with any term or provision of these Terms of Service, we also may terminate this agreement
                ...
                <section className="mb-10">
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        posted by us on this site or with respect to. The Service constitutes the entire agreement and understanding
                        between you and us and, governs your use of the Service, superseding any prior or contemporaneous
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        party. In the event of, any conflict between the English version and other translated versions of the
                        content in this Terms of Service, the English version shall prevail. In the event of, any conflict between
                        the English version and other translated versions of the content on this website, the English version shall
                        prevail.
                    </p>
                </section>
